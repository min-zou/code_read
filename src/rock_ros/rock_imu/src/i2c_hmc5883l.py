...
class i2c_hmc5883l:
	...
	def getAxes(self):
		magno_x = self.bus.readS16BE(self.AxisXDataRegisterMSB)
		magno_z = self.bus.readS16BE(self.AxisZDataRegisterMSB)
		magno_y = self.bus.readS16BE(self.AxisYDataRegisterMSB)
